            ...
            <div className="row">
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="accordion" id="accordionExample">
                        ...
                        <Accordion incharge="eventCoordinators" title="Event coordinators" />
                ...
                <div class="col-sm-12 col-md-6">
                    <div class="accordion" id="accordion2">
                        <Accordion incharge="regularActivitiesIncharges" title="Regular activities incharges" />
                        <Accordion incharge="weekendActivities" title="Weekend activities incharges" />
